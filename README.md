...
<header
  ...
  style="--scroll-head-height: 56px; --scroll-head-progress: 1;"
>
</header>
```
...
.site-header {
  position: sticky;
  top: 0;
  height: var(--scroll-head-height, 72px);
...
The preset is intentionally small. It covers sticky positioning, height/transform transitions, top versus away background, and reduced-motion behavior. You can also import only the base transition layer:
